...
description: 将 Markdown 文章转换为美化的 HTML 格式，适配微信公众号发布；应用专业 CSS 样式、代码高亮、优化排版。当用户说"美化这篇文章"、"把这篇 Markdown 转成公众号 HTML"、"转换为 HTML"、"优化公众号格式"、"排版一下准备发公众号"时，应使用本技能；通常在文章正文写好之后、发布之前这一步触发。
---

# 微信公众号文章格式化工具（Hermes 执行指南）
